...
export const PERFORMANCE_FIX_GUIDES: Record<string, FixGuideEntry> = {
  "performance.lcp": {
    effort: "involved",
    effortMinutes: 30,
    lead: "The largest visible piece of this page takes a long time to appear, so it feels slow to arrive even after other things load.",
    default: [
  ...
  "performance.cls": {
    effort: "moderate",
    effortMinutes: 20,
    lead: "Content on this page shifts around after it starts loading, which can make a visitor tap or click the wrong thing.",
    default: [
  ...
  "performance.fcp": {
    effort: "moderate",
    effortMinutes: 20,
    lead: "Visitors stare at a blank screen for a while after arriving, because nothing visible shows up on the page quickly enough.",
    default: [
  ...
  "performance.long_task_blocking": {
    effort: "involved",
    effortMinutes: 30,
    lead: "Something on the page keeps the browser busy for a long stretch, so taps and scrolls feel stuck.",
    default: [
  ...
  "performance.images": {
    effort: "moderate",
    effortMinutes: 20,
    lead: "Some images on this page may be larger or loaded earlier than they need to be, adding unnecessary weight and delay.",
    default: [
  ...
  "performance.cache": {
    effort: "moderate",
    effortMinutes: 10,
    lead: "Your server does not tell browsers how long they can safely reuse a response, so they may re-download content that has not changed.",
    default: [
  ...
  "performance.asset_caching": {
    effort: "quick",
    effortMinutes: 10,
    lead: "Files that never change once published are not set to stay cached, so returning visitors keep re-downloading them.",
    default: [
  ...
  "performance.images.lazy": {
    effort: "quick",
    effortMinutes: 5,
    lead: "Images far down the page load immediately instead of waiting until a visitor scrolls near them, competing for bandwidth.",
    default: [
  ...
  "performance.images.format": {
    effort: "moderate",
    effortMinutes: 15,
    lead: "Some images are served in an older format that is usually larger than a modern alternative at the same visual quality.",
    default: [
  ...
  "performance.images.dimensions": {
    effort: "quick",
    effortMinutes: 5,
    lead: "Some images do not declare their size ahead of time, so the page can visibly jump around as they finish loading.",
    default: [
  ...
  "performance.render_blocking": {
    effort: "moderate",
    effortMinutes: 15,
    lead: "Stylesheets or scripts loading in the page head can hold up the very first useful thing a visitor sees.",
    default: [
  ...
  "performance.compression": {
    effort: "moderate",
    effortMinutes: 10,
    lead: "Text-based responses from your server are not compressed, so visitors download more data than they actually need to.",
    default: [
  ...
  "performance.fonts": {
    effort: "quick",
    effortMinutes: 5,
    lead: "Custom fonts on this page may delay visible text or cause it to visibly shift once the real font finishes loading.",
    default: [
  ...
  "performance.page_weight": {
    effort: "moderate",
    effortMinutes: 15,
    lead: "The raw page document itself is unusually large, which can slow down how quickly anything starts to appear.",
    default: [
  ...
  "performance.asset_weight": {
    effort: "moderate",
    effortMinutes: 20,
    lead: "The combined size of this page's images, scripts, and styles is unusually heavy, adding to load time and data use.",
    default: [
  ...
  "performance.images.heavy": {
    effort: "moderate",
    effortMinutes: 15,
    lead: "The image version a browser actually selects for this page is unusually large for how small it is shown.",
    default: [
  ...
  "performance.http2": {
    effort: "moderate",
    effortMinutes: 15,
    lead: "Your site may not be using a modern connection protocol, which can slow down loading several resources at once.",
    default: [
  ...
  "performance.dom_size": {
    effort: "involved",
    effortMinutes: 30,
    lead: "This page renders an unusually large number of elements, which can slow down both rendering and how it responds to input.",
    default: [
  ...
  "performance.third_party": {
    effort: "moderate",
    effortMinutes: 20,
    lead: "This page loads a large number of third-party scripts, and each one adds its own load time, risk, and privacy exposure.",
    default: [
  ...
  "performance.unminified": {
    effort: "quick",
    effortMinutes: 5,
    lead: "A large chunk of formatted script or style code ships inline on the page instead of being compacted for production.",
    default: [
  ...
  "performance.redirect_chain": {
    effort: "quick",
    effortMinutes: 5,
    lead: "A request to this page bounces through more than one redirect before reaching its real destination, adding delay.",
    default: [
  ...
  "performance.inline_css": {
    effort: "moderate",
    effortMinutes: 15,
    lead: "An unusually large amount of styling is written directly into this page instead of a stylesheet browsers can cache.",
    default: [
  ...
  "performance.ttfb": {
    effort: "involved",
    effortMinutes: 30,
    lead: "Your server takes a long time to send even the first byte of a response, delaying everything that has to follow it.",
    default: [
  ...
  "performance.tbt": {
    effort: "involved",
    effortMinutes: 30,
    lead: "A lab test shows this page's main thread stays busy for a long stretch, which can make early taps and clicks feel unresponsive.",
    default: [
