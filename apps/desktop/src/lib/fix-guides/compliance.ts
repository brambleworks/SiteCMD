...
export const COMPLIANCE_FIX_GUIDES: Record<string, FixGuideEntry> = {
  "compliance.cookie_consent": {
    effort: "moderate",
    effortMinutes: 15,
    lead: "Cookies and tracking scripts appear to run before a visitor has made any consent choice, which some privacy laws forbid.",
    default: [
  ...
  "compliance.privacy_policy": {
    effort: "involved",
    effortMinutes: 30,
    lead: "This site has no privacy policy telling visitors what data it collects and why, which most privacy laws require.",
    default: [
  ...
  "compliance.terms": {
    effort: "involved",
    effortMinutes: 30,
    lead: "This site has no terms of service, leaving accounts, payments, or other visitor relationships without agreed rules.",
    default: [
  ...
  "compliance.ccpa_notice": {
    effort: "moderate",
    effortMinutes: 15,
    lead: "This site may share personal information without the clear opt-out notice that California and similar laws require.",
    default: [
  ...
  "compliance.cookie_expiration": {
    effort: "quick",
    effortMinutes: 5,
    lead: "A cookie on this site is set to last far longer than its actual purpose likely needs, which can raise compliance concerns.",
    default: [
  ...
  "compliance.data_controller_contact": {
    effort: "quick",
    effortMinutes: 5,
    lead: "This site's privacy notice does not name who is responsible for visitor data or how to reach them with a request.",
    default: [
  ...
  "compliance.form_consent": {
    effort: "moderate",
    effortMinutes: 15,
    lead: "A form on this site collects personal information without a clear explanation of why or the consent that may be required.",
    default: [
  ...
  "compliance.consent_mode": {
    effort: "moderate",
    effortMinutes: 20,
    lead: "Google's tracking tags on this site do not appear to change what they collect based on a visitor's consent choice.",
    default: [
