...
export const SCAFFOLDING_FIX_GUIDES: Record<string, CodeFixGuideEntry> = {
  "agent-instructions-stub": {
    effort: "moderate",
    effortMinutes: 20,
    lead: "The file meant to guide AI coding agents is too thin to be useful, missing the real commands and rules they need.",
    default: [
  ...
  "agent-instructions-fragmented": {
    effort: "quick",
    effortMinutes: 10,
    lead: "Guidance for AI coding agents is scattered across multiple files instead of one canonical source, risking drift.",
    default: [
  ...
  "agent-instructions-secret": {
    effort: "quick",
    effortMinutes: 15,
    lead: "A value that looks like a real credential is written directly into the file meant to guide AI coding agents.",
    default: [
