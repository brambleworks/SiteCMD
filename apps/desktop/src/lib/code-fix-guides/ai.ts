...
export const AI_FIX_GUIDES: Record<string, CodeFixGuideEntry> = {
  "ai-cache-dedupe": {
    effort: "moderate",
    effortMinutes: 20,
    lead: "Identical AI requests are not being deduplicated or cached, so the same call can run and get billed more than once.",
    default: [
  ...
  "ai-concurrency": {
    effort: "moderate",
    effortMinutes: 15,
    lead: "Nothing limits how many AI calls can run at once, so a burst of activity can overwhelm the provider or the budget.",
    default: [
  ...
  "ai-kill-switch-missing": {
    effort: "quick",
    effortMinutes: 10,
    lead: "There is no quick way to turn off AI calls in production if something goes wrong, like runaway spend or bad output.",
    default: [
  ...
  "ai-loop-risk": {
    effort: "moderate",
    effortMinutes: 15,
    lead: "A loop that calls an AI provider has no clear limit on iterations, risking a runaway sequence of paid calls.",
    default: [
  ...
  "ai-observability": {
    effort: "moderate",
    effortMinutes: 20,
    lead: "Calls to the AI provider are not being logged or measured, so failures and slow responses can go unnoticed.",
    default: [
  ...
  "ai-observability-integration-missing": {
    effort: "moderate",
    effortMinutes: 25,
    lead: "No monitoring backend is wired up to track AI call latency, errors, or usage over time, so problems can hide.",
    default: [
  ...
  "ai-output-cap": {
    effort: "quick",
    effortMinutes: 5,
    lead: "This AI call sets no limit on how much output it can generate, risking an unexpectedly long and costly response.",
    default: [
  ...
  "ai-rate-limit": {
    effort: "moderate",
    effortMinutes: 15,
    lead: "Nothing limits how often a visitor can trigger this AI call, leaving it open to abuse and runaway cost.",
    default: [
  ...
  "ai-request-validation": {
    effort: "moderate",
    effortMinutes: 15,
    lead: "User input flows into an AI prompt without validation first, which can let unexpected or malicious content reach the model.",
    default: [
  ...
  "ai-retry-bounds": {
    effort: "quick",
    effortMinutes: 10,
    lead: "A failed AI call retries without a clear limit, which can multiply cost and delay when the provider is struggling.",
    default: [
  ...
  "ai-spend-guardrails": {
    effort: "moderate",
    effortMinutes: 20,
    lead: "Nothing stops AI usage here from running up unexpected cost before anyone notices, since there is no spend limit.",
    default: [
  ...
  "ai-timeout": {
    effort: "quick",
    effortMinutes: 5,
    lead: "This AI call has no deadline, so a slow or stalled provider response can leave the request hanging indefinitely.",
    default: [
  ...
  "ai-user-controlled-model": {
    effort: "quick",
    effortMinutes: 10,
    lead: "The client can choose which AI model actually gets used, letting it pick an unapproved or costlier one than intended.",
    default: [
  ...
  "ai-user-controlled-settings": {
    effort: "quick",
    effortMinutes: 10,
    lead: "The client can send arbitrary AI generation settings straight to the provider, bypassing any limits the product intends.",
    default: [
  ...
  "ai-conversation-artifacts": {
    effort: "quick",
    effortMinutes: 5,
    lead: "Leftover conversational phrasing from an AI assistant is sitting in the committed source instead of a normal comment.",
    default: [
