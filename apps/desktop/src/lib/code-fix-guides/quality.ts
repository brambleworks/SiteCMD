...
export const QUALITY_FIX_GUIDES: Record<string, CodeFixGuideEntry> = {
  "client-ai-sdk": {
    effort: "moderate",
    effortMinutes: 20,
    lead: "An AI provider's long-lived API key looks like it is reachable from code that ships to the browser.",
    default: [
  ...
  "client-db-access": {
    effort: "involved",
    effortMinutes: 30,
    lead: "A server-only database driver appears to be used directly in code that runs in the browser, bypassing your backend.",
    default: [
  ...
  "config-secret": {
    effort: "quick",
    effortMinutes: 10,
    lead: "A value that looks like a real credential is hardcoded directly in a configuration file instead of a secret store.",
    default: [
  ...
  "critical-path-no-test": {
    effort: "involved",
    effortMinutes: 45,
    lead: "A critical path like authentication or payment has no automated test covering it, so a regression could go unnoticed.",
    default: [
  ...
  "god-module": {
    effort: "involved",
    effortMinutes: 45,
    lead: "One file has grown to own an unusually wide range of unrelated responsibilities, making it hard to change safely.",
    default: [
  ...
  "god-route": {
    effort: "moderate",
    effortMinutes: 20,
    lead: "A single route handler mixes authentication, validation, and business logic together, making it hard to test in isolation.",
    default: [
  ...
  "oversized-module": {
    effort: "moderate",
    effortMinutes: 25,
    lead: "This file has grown unusually large, which can make it harder to review, test, and safely change.",
    default: [
  ...
  "error-boundary-missing": {
    effort: "moderate",
    effortMinutes: 15,
    lead: "This application has no error boundary around its main content, so one component crash can blank the whole screen.",
    default: [
  ...
  "error-reporting-missing": {
    effort: "moderate",
    effortMinutes: 20,
    lead: "Failures in this application are not reported anywhere, so problems in production can go unnoticed until a user complains.",
    default: [
  ...
  "external-call-retry": {
    effort: "moderate",
    effortMinutes: 15,
    lead: "A call to an external service has no retry behavior, so a brief network hiccup can fail the whole request outright.",
    default: [
  ...
  "external-call-timeout": {
    effort: "quick",
    effortMinutes: 5,
    lead: "A call to an external service has no timeout, so a stalled response can leave the request hanging indefinitely.",
    default: [
  ...
  "healthcheck-missing": {
    effort: "quick",
    effortMinutes: 10,
    lead: "This service has no health check endpoint, so the hosting platform has no reliable way to tell if it is actually working.",
    default: [
  ...
  "recovery-runbook-missing": {
    effort: "moderate",
    effortMinutes: 25,
    lead: "There is no documented recovery process for this system's likely failures, so an incident would rely on someone's memory.",
    default: [
  ...
  "structured-logging-missing": {
    effort: "moderate",
    effortMinutes: 15,
    lead: "This server logs with scattered plain print statements instead of a consistent, searchable structured format.",
    default: [
  ...
  "job-visibility-missing": {
    effort: "moderate",
    effortMinutes: 20,
    lead: "Background jobs in this system provide no way to see their state, so a stuck or failed job can go unnoticed.",
    default: [
  ...
  "ci-workflow-missing": {
    effort: "moderate",
    effortMinutes: 20,
    lead: "This repository has no continuous integration workflow, so nothing automatically checks a change before it merges.",
    default: [
  ...
  "ci-quality-gate-missing": {
    effort: "quick",
    effortMinutes: 10,
    lead: "Continuous integration runs on this repository but never runs the build, lint, or test commands that would catch a bad change.",
    default: [
  ...
  "build-script-missing": {
    effort: "quick",
    effortMinutes: 10,
    lead: "This project has no production build script, so a real build step is not guaranteed to run before it deploys.",
    default: [
  ...
  "ci-only-builds": {
    effort: "moderate",
    effortMinutes: 15,
    lead: "Continuous integration here only runs the production build, with no lint, typecheck, or test step to catch real errors.",
    default: [
  ...
  "pre-commit-hooks-missing": {
    effort: "moderate",
    effortMinutes: 15,
    lead: "This repository has no pre-commit hooks, so nothing stops an obviously broken change from being committed.",
    default: [
  ...
  "pre-commit-hooks-weak": {
    effort: "quick",
    effortMinutes: 10,
    lead: "This repository's commit hook exists but does not actually run any check that could catch a real problem.",
    default: [
  ...
  "runtime-version-eol": {
    effort: "moderate",
    effortMinutes: 25,
    lead: "This project targets a runtime version that is at or approaching the end of its official support window.",
    default: [
  ...
  "deploy-rollback-plan-missing": {
    effort: "moderate",
    effortMinutes: 20,
    lead: "There is no documented way to roll back a bad deploy, so recovering from one would mean improvising under pressure.",
    default: [
  ...
  "backup-restore-plan-missing": {
    effort: "moderate",
    effortMinutes: 25,
    lead: "There is no documented backup and restore plan for this system's data, so recovering from data loss is untested.",
    default: [
  ...
  "jsx-inline-style-density": {
    effort: "moderate",
    effortMinutes: 15,
    lead: "A component writes an unusually large amount of styling inline instead of reusing classes or shared styles.",
    default: [
  ...
  "direct-url-dependency": {
    effort: "quick",
    effortMinutes: 10,
    lead: "A dependency is installed straight from a Git URL or branch instead of a versioned, verifiable registry release.",
    default: [
  ...
  "lockfile-missing": {
    effort: "quick",
    effortMinutes: 5,
    lead: "This project has no lockfile, so different installs can silently resolve different dependency versions.",
    default: [
  ...
  "unpinned-github-action": {
    effort: "moderate",
    effortMinutes: 20,
    lead: "A workflow references a third-party GitHub Action by a movable tag instead of a fixed commit, so its code can change under you.",
    default: [
  ...
  "workflow-script-injection": {
    effort: "quick",
    effortMinutes: 10,
    lead: "A workflow script directly embeds attacker-controllable text, like a pull request title, into a shell command.",
    default: [
  ...
  "npmrc-committed-token": {
    effort: "quick",
    effortMinutes: 10,
    lead: "An authentication token for a package registry appears to be committed directly in a checked-in npmrc file.",
    default: [
  ...
  "dockerfile-unpinned-base": {
    effort: "quick",
    effortMinutes: 5,
    lead: "A Dockerfile's base image has no specific version tag, so a rebuild can silently pull in different, untested code.",
    default: [
  ...
  "remote-pipe-to-shell": {
    effort: "moderate",
    effortMinutes: 15,
    lead: "A script downloads a remote file and pipes it straight into a shell, running unverified code with no chance to inspect it first.",
    default: [
  ...
  "workflow-pr-target-checkout": {
    effort: "moderate",
    effortMinutes: 20,
    lead: "A privileged workflow checks out a pull request's own code while running with elevated permissions and secrets.",
    default: [
  ...
  "lockfile-integrity-weak": {
    effort: "quick",
    effortMinutes: 10,
    lead: "Some lockfile entries are missing a strong integrity check, so npm cannot fully verify those packages were not tampered with.",
    default: [
  ...
  "nextconfig-errors-ignored": {
    effort: "moderate",
    effortMinutes: 30,
    lead: "This Next.js configuration tells the build to ignore TypeScript or lint errors instead of failing on them.",
    default: [
  ...
  "release-age-policy-missing": {
    effort: "quick",
    effortMinutes: 5,
    lead: "This project installs new package releases immediately, with no waiting period to catch a compromised release first.",
    default: [
  ...
  "unbounded-dependency-range": {
    effort: "quick",
    effortMinutes: 10,
    lead: "A dependency is pinned to an unbounded version range, so an install can silently pull in a newer, untested release.",
    default: [
  ...
  "workflow-write-all-permissions": {
    effort: "moderate",
    effortMinutes: 15,
    lead: "A workflow grants itself write access to everything in the repository instead of just what each job actually needs.",
    default: [
  ...
  "tsconfig-strict-off": {
    effort: "moderate",
    effortMinutes: 30,
    lead: "This TypeScript configuration has strict mode turned off, so the type checker misses errors it would otherwise catch.",
    default: [
  ...
  "lockfile-mismatch": {
    effort: "quick",
    effortMinutes: 5,
    lead: "The dependency manifest and the lockfile no longer agree, so a frozen install can fail or resolve unexpected versions.",
    default: [
  ...
  "registry-host-mismatch": {
    effort: "moderate",
    effortMinutes: 15,
    lead: "A dependency appears to resolve from a registry host that does not match the project's expected or approved source.",
    default: [
  ...
  "undeclared-package": {
    effort: "quick",
    effortMinutes: 5,
    lead: "Code imports a package that is never declared in the project's manifest, relying on it being present only by accident.",
    default: [
  ...
  "unused-dependency": {
    effort: "quick",
    effortMinutes: 10,
    lead: "A package listed in the manifest does not appear to be used anywhere in the actual source code.",
    default: [
  ...
  "empty-catch-blocks": {
    effort: "moderate",
    effortMinutes: 15,
    lead: "An error is caught here and then silently discarded, so a real failure would leave no trace anywhere.",
    default: [
  ...
  "console-log-error-handling": {
    effort: "moderate",
    effortMinutes: 15,
    lead: "An error is only printed to the console instead of going through the project's real error reporting.",
    default: [
  ...
  "typescript-any-abuse": {
    effort: "involved",
    effortMinutes: 30,
    lead: "This file relies heavily on the any type, which turns off the type checking that would otherwise catch real bugs.",
    default: [
  ...
  "no-automated-tests": {
    effort: "involved",
    effortMinutes: 30,
    lead: "This project has no automated tests at all, so there is nothing to catch a regression before it ships.",
    default: [
  ...
  "linter-missing": {
    effort: "moderate",
    effortMinutes: 10,
    lead: "This project has no linter configured, so common bugs and style problems go uncaught before they reach production.",
    default: [
  ...
  "placeholder-density": {
    effort: "involved",
    effortMinutes: 30,
    lead: "This codebase carries an unusually high number of TODO and placeholder markers, hinting at real unfinished work.",
    default: [
  ...
  "no-pagination": {
    effort: "moderate",
    effortMinutes: 15,
    lead: "An endpoint returns an entire collection with no limit, so it can slow down or fail outright as the data grows.",
    default: [
  ...
  "duplicate-utility-deps": {
    effort: "moderate",
    effortMinutes: 20,
    lead: "This project depends on more than one library that does the same job, adding weight and upkeep for no real benefit.",
    default: [
