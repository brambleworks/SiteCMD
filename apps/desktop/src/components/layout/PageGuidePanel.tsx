...
import type { PageGuideKey } from "@/components/layout/PageGuide";
...
// Guide copy loads with the panel, so the shell header does not carry it.
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          "Run a new scan after changing the site or its code so the Dashboard reflects the current state.",
